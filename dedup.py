...
parser_alg.add_argument('-a', '--algorithm', action = 'store', default = 'weighed_average2', choices = ['naive', 'weighted_average', 'weighted_average2', 'cluster'], help = 'algorithm for duplicate identification')
